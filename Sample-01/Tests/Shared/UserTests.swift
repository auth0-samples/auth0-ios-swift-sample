...
class UserTests: XCTestCase {
    ...
    func testReturnsEmptyUserWhenIDTokenDecodingFails() {
        XCTAssertEqual(User.from("foo.bar.baz"), User.empty)
    }

    func testReturnsEmptyUserWhenSubjectIsMissing() {
    ...
    func testReturnsEmptyUserWhenNameIsMissing() {
    ...
    func testReturnsEmptyUserWhenEmailIsMissing() {
    ...
    func testReturnsEmptyUserWhenUpdatedAtIsMissing() {
        let idToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJmb28iLCJuYW1lIjoiYmFyIiwiZW1haWwiOiJmb29AZXhhbXB"
